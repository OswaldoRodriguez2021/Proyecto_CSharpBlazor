...
namespace BlazorExpenseTracker
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<ICategoriService, CategoryService>(
                client => { client.BaseAddress = new Uri("https://localhost:44395"); });

            services.AddHttpClient<IExpenseService, ExpenseServices>(
